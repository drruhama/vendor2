    ...
    <div>
      <form action={formAction}>
        <div className="mb-5">
          ...
          focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Full Name..."/>
        </div>
        ...
        <div className="mb-5">
          ...
          focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Phone Number..."/>
        </div>
